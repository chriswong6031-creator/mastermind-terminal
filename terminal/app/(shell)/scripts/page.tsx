...
// Scripts workspace — the Pine editor. Serves /scripts under the (shell) route group
// (route groups don't affect the path); shared chrome from app/(shell)/layout.tsx.
// PineEditor renders content-only (<main className="main2">).
//
// Scripts is Pro-gated on SAVE (server-side in /api/scripts/save via profiles.is_pro)
// but readable/runnable for everyone — so this page hands PineEditor the full list:
// the locked proprietary flagship (viewable, never editable) prepended to the
