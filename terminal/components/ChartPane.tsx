...
export default function ChartPane({ idx, symbol, isActive, onActivate, row, tf, chartType, inds, tool, detectCmd, compare, magnet, replayIdx, onMeta, drawings, onDrawingsChange, indParams, hidden, onToggleHidden, onRemoveInd, onOpenSettings, onOpenSource }:
