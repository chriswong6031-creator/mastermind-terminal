  ...
  return (
    <div className={`pane${isActive ? " on" : ""}`} onPointerDownCapture={() => { if (!isActive) onActivate(idx); }}>
      ...
      <ChartPanel
        ...
        tool={isActive ? tool : null} drawingSticky={isActive && drawingSticky} drawStyle={drawStyle} drawings={merged}
