    ...
    <div className="scrim" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="smodal" onClick={(e) => e.stopPropagation()}>
        <div className="sh">
          ...
          <input ref={inputRef} value={q} placeholder={t("searchPlaceholder")} onChange={(e) => { setQ(e.target.value); setSel(0); }} onKeyDown={key} />
            ...
            return (
              <div key={s} className={`r${i === sel ? " sel" : ""}`} onMouseEnter={() => setSel(i)} onClick={() => { onPick(s); onClose(); }}>
                ...
                <div className="vr">
                  ...
                  <button className={`add${added ? " added" : ""}`} title={added ? t("inWatchlist") : t("addToWatchlist")} onClick={(e) => { e.stopPropagation(); onAdd(s); }}>
