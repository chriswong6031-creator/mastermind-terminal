        ...
        {points.map((p, i) => {
          ...
          return (
            <g key={i}
              ...
              {ye != null && <circle className="fin-dot-est" cx={cx} cy={ye} r={3.4} fill="var(--panel)" stroke={estimateColor} />}
              {ya != null && <circle className="fin-dot-act" cx={cx} cy={ya} r={3.4} fill={actualColor} />}
            </g>
          );
        })}
      </svg>
...
function XAxis({ labels, small }: { labels: string[]; small?: boolean }) {
  return (
    <div className={"fin-xaxis" + (small ? " fin-xaxis-sm" : "")}>
