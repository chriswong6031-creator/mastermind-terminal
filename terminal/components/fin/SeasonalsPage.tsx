...
export default function SeasonalsPage({ sym, bars = [], zh = false }: SeasonalsPageProps) {
    ...
    <div className="fin-seas">
      ...
      {view === "chart" ? (
        <div className="fin-sec">
          <YearOverlay paths={paths} horizon={HORIZON} monthLabels={monthLabels} vw={720} vh={300} zh={zh} />
        </div>
      ) : (
