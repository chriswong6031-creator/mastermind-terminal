...
export function LevelsLearn() {
  return (
    <div style={PAGE}>
      <header style={TOPBAR}>
        <Link href="/flow?tab=levels" style={{ textDecoration: "none" }}>
          <BrandLockup />
        </Link>
        <Link href="/flow?tab=levels" style={BACK_LINK}>← Back to the board</Link>
      </header>
      ...
      <main style={MAIN}>
        ...
        <div style={FOOT}>
          <Link href="/flow?tab=levels" style={FOOT_CTA}>Open the Levels board →</Link>
