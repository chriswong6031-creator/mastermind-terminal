...
const LEX: Record<string, [string, string]> = {
  ...
  radarCoverage: ["{n} names · {nRev} revision-uncovered", "{n} 个标的 · {nRev} 个无修订覆盖"],
  radarRevUncovered: ["revision-uncovered", "无修订覆盖"],
  radarRevUncoveredTooltip: ["Names without analyst revision coverage", "无分析师修订覆盖的标的"],
  radarRegimeBanner: ["Regime", "市场状态"],
  radarRegimeWeighting: ["weighting", "权重"],
  radarStateGroup: ["State", "状态"],
  radarDaysInState: ["days", "天"],
  radarSeeding: ["seeding", "培育中"],
  radarEvidence: ["evidence", "证据"],
  radarFireWatch: ["watch-window entry", "观察窗口进入"],
  radarFireOnset: ["onset entry", "启动进入"],
  radarDeEsc: ["de-escalation", "降级信号"],
  ...
  radarHandoffExtended: ["extended-leg basket", "延伸腿组合"],
  radarHandoffBasing: ["basing-leg names", "基础腿标的"],
  ...
  radarNoHandoff: ["No extended-leg baskets currently", "当前无延伸腿组合"],
  radarOscMacdPos: ["MACD pos", "MACD正"],
