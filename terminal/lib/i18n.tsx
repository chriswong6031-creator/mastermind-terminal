...
const LEX: Record<string, [string, string]> = {
  ...
  indicatorsSubtitle: ["Find, add, and configure chart tools", "查找、添加和配置图表工具"],
  indicatorSearchPlaceholder: ["Search indicators, modules, or aliases…", "搜索指标、模块或别名…"],
  clearSearch: ["Clear search", "清除搜索"],
  noIndicatorMatches: ["No matching indicators or scripts", "没有匹配的指标或脚本"],
  close: ["Close", "关闭"],
  library: ["Library", "指标库"],
  ...
  preMarket: ["Pre-market", "盘前"],
  afterHours: ["After-hours", "盘后"],
